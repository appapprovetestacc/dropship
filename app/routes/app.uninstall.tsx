...
export function loader({ context }: LoaderFunctionArgs) {
  ...
  return Response.json({
    ...
    steps: [
      ...
      "Uninstall " + "dropship" + " from Shopify admin > Settings > Apps and sales channels.",
      "Verify the mandatory shop/redact webhook fired and completed data cleanup.",
    ],
    dataRetention:
      "dropship" + " deletes or anonymizes shop data after uninstall and shop/redact processing. The standard deletion SLA is 30 days.",
